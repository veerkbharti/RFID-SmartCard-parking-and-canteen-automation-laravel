...
@section('main-container')
    ...
    <div class="content-wrapper">
        ...
        <!-- /.content-header -->
        @if (session('food-add-success'))
            <x-alert-message type="success" message="{{ session('food-add-success') }}" />
        @endif
        <!-- Main content -->
                        ...
                        <div class="card-body">
                            <form action="./add" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea rows="2" name="description" id="description" required class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <label for="thumbnail" class="col-sm-3 col-form-label">Thumbnail :</label>
                                    <div class="col-sm-6">
                                        <input type="file" accept="image/*" name="thumbnail" id="thumbnail" required class="form-control">
                                    </div>
                                </div>
